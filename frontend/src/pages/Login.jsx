  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ position:"absolute", width:40, height:40, borderRadius:"50%", border:`2px solid rgba(224,197,143,0.12)`, bottom:180, left:"25%", pointerEvents:"none" }}/>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              marginBottom:28, animation:"goldLine 1s ease forwards",
            }}/>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
              {features.map((f, i) => (
                <div key={i} style={{ display:"flex", alignItems:"flex-start", gap:16 }}>
                  ...
                  <div>
                    <div style={{ color:C.gold, fontSize:13, fontWeight:"bold", marginBottom:3, letterSpacing:"0.3px" }}>
                      {f.title}
                    </div>
                    <div style={{ color:C.shell, fontSize:12, lineHeight:1.6, opacity:0.8 }}>
                      {f.desc}
                    </div>
                  </div>
                </div>
            ...
            <div style={{
              ...
              borderTop:`1px solid rgba(224,197,143,0.15)`,
            }}>
        ...
        <div style={{
          ...
          <div style={{ marginBottom:20 }}>
            ...
            <input
              style={inputStyle("email")} type="email" placeholder="ahmed@univ.dz"
          ...
          <div style={{ marginBottom:28 }}>
            <div style={{
              fontSize:11, color:C.sapphire, fontWeight:"bold",
          ...
          >
            {loading ? (
              <span style={{
                width:16, height:16, border:`2px solid ${C.gold}`,
