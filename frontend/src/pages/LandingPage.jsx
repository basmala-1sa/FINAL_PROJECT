...
export default function LandingPage() {
  ...
  return (
    <div style={{fontFamily:"Georgia,serif",background:C.cream,overflowX:"hidden",color:C.navy}}>
      ...
      {/* ══ HERO ══ */}
      <section style={{minHeight:"100vh",position:"relative",overflow:"hidden",background:`linear-gradient(150deg,${C.cream} 0%,#EDF2FF 55%,${C.offWhite} 100%)`,display:"flex",alignItems:"center",padding:"100px 5% 60px"}}>
        <ParticleCanvas/>
        ...
        <div style={{maxWidth:"1100px",margin:"0 auto",width:"100%",display:"grid",gridTemplateColumns:"1fr 1fr",gap:"60px",alignItems:"center",position:"relative",zIndex:1}}>
          <div>
            ...
            <h1 style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:"clamp(42px,5.5vw,70px)",fontWeight:"600",color:C.navy,lineHeight:1.1,margin:"0 0 22px",animation:titleVisible?"fadeUp .6s ease .1s both":"none"}}>
            ...
            <div style={{display:"flex",gap:"12px",flexWrap:"wrap",animation:titleVisible?"fadeUp .6s ease .35s both":"none"}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:"0",marginTop:"32px",background:"rgba(255,255,255,0.7)",backdropFilter:"blur(8px)",border:"1px solid rgba(17,34,80,0.07)",borderRadius:"12px",overflow:"hidden",animation:titleVisible?"fadeUp .6s ease .5s both":"none"}}>
          ...
          <div style={{animation:titleVisible?"slideR .8s ease .2s both":"none"}}><HeroSlider/></div>
        </div>
      ...
      <section style={{padding:"96px 5%",background:C.offWhite}}>
        <div style={{maxWidth:"1100px",margin:"0 auto"}}>
          ...
          <div ref={featRef} style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"22px"}}>
            {features.map((f,i)=>(
      ...
      {/* ══ HOW IT WORKS ══ */}
      <section style={{padding:"96px 5%",background:C.offWhite,position:"relative",overflow:"hidden"}}>
        ...
        <div style={{maxWidth:"1100px",margin:"0 auto",position:"relative"}}>
          ...
          <div ref={stepsRef} style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"28px",position:"relative"}}>
            <div style={{position:"absolute",top:"33px",left:"12%",right:"12%",height:"1px",background:`linear-gradient(90deg,transparent,rgba(194,160,114,0.3),transparent)`}}/>
            {steps.map((s,i)=>(
      ...
      <section style={{padding:"96px 5%",background:C.cream}}>
        <div style={{maxWidth:"1100px",margin:"0 auto"}}>
          ...
          <div ref={revRef} style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"22px"}}>
      ...
      {/* ══ CTA ══ */}
      <section ref={ctaRef} style={{padding:"96px 5%",background:`linear-gradient(135deg,${C.navy} 0%,${C.navyMid} 100%)`,position:"relative",overflow:"hidden"}}>
